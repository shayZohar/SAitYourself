(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@crystalui/angular-lightbox', ['exports', '@angular/common', 'rxjs', '@angular/core'], factory) :
    (factory((global.crystalui = global.crystalui || {}, global.crystalui['angular-lightbox'] = {}),global.ng.common,global.rxjs,global.ng.core));
    ...
    var LightboxCommonComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        LightboxCommonComponent.ctorParameters = function () {
            return [
                { type: EventService }
            ];
        };
        LightboxCommonComponent.propDecorators = {
            lightboxData: [{ type: core.Input }],
            ...
            _imageFirst: [{ type: core.ViewChild, args: ['imageFirst',] }],
            _imageSecond: [{ type: core.ViewChild, args: ['imageSecond',] }],
            _imageLast: [{ type: core.ViewChild, args: ['imageLast',] }],
            _lightboxImage: [{ type: core.ViewChild, args: ['lightboxImage',] }]
        };
    ...
    ***************************************************************************** */
    ...
    var LightboxComponent = /** @class */ (function (_super) {
        ...
        LightboxComponent.propDecorators = {
            hostShown: [{ type: core.HostBinding, args: ['class.lightbox-shown',] }],
            hideControls: [{ type: core.HostBinding, args: ['class.lightbox-hide-controls',] }],
            hostAnimation: [{ type: core.HostBinding, args: ['class.lightbox-animation',] }],
            simpleMode: [{ type: core.HostBinding, args: ['class.lightbox-simple-mode',] }],
            hostLightTheme: [{ type: core.HostBinding, args: ['class.lightbox-light',] }],
            hostStyleBackgroundColor: [{ type: core.HostBinding, args: ['style.backgroundColor',] }],
            prevImageElem: [{ type: core.ViewChild, args: ['prevImageElem',] }],
            lightboxContainerElem: [{ type: core.ViewChild, args: ['lightboxContainer',] }],
            scrolling: [{ type: core.HostListener, args: ['window:scroll',] }],
    ...
    var LightboxDirective = /** @class */ (function () {
        ...
        LightboxDirective.propDecorators = {
            ...
            imageMaxHeight: [{ type: core.Input }],
            imageMaxWidth: [{ type: core.Input }],
            animationDuration: [{ type: core.Input }],
            animationMode: [{ type: core.Input }],
            animationTimingFunction: [{ type: core.Input }],
            closeButtonText: [{ type: core.Input }],
            counterSeparator: [{ type: core.Input }],
            disable: [{ type: core.Input }],
            simpleMode: [{ type: core.Input }],
            backgroundColor: [{ type: core.Input }],
            hideThumbnail: [{ type: core.Input }],
            gestureEnable: [{ type: core.Input }],
            events: [{ type: core.Output }],
            hostLightboxGroup: [{ type: core.HostBinding, args: ['class.lightbox-single',] }],
            hostSimpleMode: [{ type: core.HostBinding, args: ['class.lightbox-simple-mode',] }],
    ...
    var LightboxGroupDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        LightboxGroupDirective.ctorParameters = function () {
            return [
                { type: EventService },
                { type: CrystalLightbox }
            ];
        ...
        LightboxGroupDirective.propDecorators = {
            hostLightboxGroup: [{ type: core.HostBinding, args: ['class.lightbox-group',] }],
            _lightboxDirectiveList: [{ type: core.ContentChildren, args: [LightboxDirective, { descendants: true },] }]
        };
    ...
    exports.ɵe = LightboxGroupDirective;
    exports.ɵb = LightboxComponent;
    exports.ɵc = LightboxDirective;
    exports.ɵd = CrystalLightbox;
