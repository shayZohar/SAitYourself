...
namespace server.Controllers
{
    ...
    public class MessageController : ControllerBase
    {
        ...
        ///////////////////////////////////////////////////////
        // get message by email of reciever
        ...
        ////////////////////////////////////////
        // geting all sent messages of user 
        ////////////////////////////////////////
        [AllowAnonymous]
        ...
        {
            bool result = await _messageService.DeleteMessage(messageId);
            if (result == false)
        ...
        {
            bool result = await _messageService.SetmessageAsRead(messageId, read);
            if (result == false)
        ...
        {
            bool result = await _messageService.SetAsReadMesages(recieverId);
            if (result == false)
